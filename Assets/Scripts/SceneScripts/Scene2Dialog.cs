...
public class Scene2Dialog : MonoBehaviour
{
    ...
    public void Next()
    {
        ...
        else if (primeInt == 37)
        {
            ...
            Synopsis.transform.Find("synText").GetComponent<TMP_Text>().text = "Article 12: Prisoners of war are under the responsibility of the detaining power, which must ensure their safety.";
